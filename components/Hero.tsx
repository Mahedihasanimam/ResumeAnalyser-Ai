...
export const HeroSection: React.FC = () => {
    return (
        <div className="relative bg-white rounded-lg p-8 sm:p-12  overflow-hidden ">
            ...
            <div className="relative z-10 max-w-4xl mx-auto text-center">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-6 text-xs text-gray-500">
                    <div className="flex items-center gap-3">
                        <div className="flex -space-x-2">
                            {[1, 2, 3].map((item) => (
                                <div key={item} className="w-6 h-6 rounded-full border-2 border-gray-300 bg-yellow-500 overflow-hidden">
                                    <Image
                                        src={`https://api.dicebear.com/7.x/bottts/png?seed=${item}`}
                                        alt="avatar"
                                        width={50}
                                        height={50}
                    ...
                    <div className="flex items-center gap-2 text-[#34A853]">
                        ...
                        <span className="text-gray-600">এনালাইসিস ফ্রি</span>
                    </div>
                </div>
